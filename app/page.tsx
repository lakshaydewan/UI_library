      ...
      <div>
        <div className="bg-white h-screen  w-screen flex justify-center items-center">
          <div className="overflow-hidden h-12 group cursor-pointer font-sans font-extralight">
            ...
            <div className="z-50 w-full h-12 bg-black text-white flex items-center px-8 group-hover:-translate-y-12 group-hover:-translate-x-0 -translate-x-10 transition-all duration-500 rotate-[20deg] group-hover:rotate-0 opacity-0 group-hover:opacity-100">
